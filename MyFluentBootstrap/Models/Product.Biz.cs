...
namespace MyFluentBootstrap.Models
{
    ...
    public partial class Product : Entity<Product>
    {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            if (isNew && !Dirtys[_.AddTime]) AddTime = DateTime.Now;
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Product数据……", typeof(Product).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Product数据！", typeof(Product).Name);
        //}
        ...
        {
            if (Meta.Count >= 1000)
                return Find(_.ProductID, productid);
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.ProductID, productid);
            // 单对象缓存
            //return Meta.SingleCache[productid];
        }
        #endregion
